...
// Tentukan tanggal untuk hasil pertandingan (default: kemarin)
$date = isset($_GET['date']) ? $_GET['date'] : date('Y-m-d', strtotime('-1 day'));

// Ambil data hasil pertandingan
$results = callAPI('livescores/', ['t' => 'ended', 'd' => $date]);
?>
...
<head>
    ...
    <title>Hasil Pertandingan - BolaNow</title>
    <meta name="description" content="Hasil pertandingan sepak bola dari seluruh dunia">
    <meta name="keywords" content="hasil pertandingan, sepak bola, skor, hasil bola">
...
<body class="bg-gray-100 text-gray-800">
    ...
    <header class="bg-green-700 text-white shadow-md">
            ...
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden md:block">
                    <ul class="flex space-x-6">
                        ...
                        <li><a href="hasil.php" class="hover:text-yellow-300 font-medium">Hasil</a></li>
        ...
        <div class="md:hidden hidden bg-green-800" id="mobile-menu">
            <ul class="px-4 py-2">
                ...
                <li class="py-2"><a href="hasil.php" class="block hover:text-yellow-300 font-medium">Hasil</a></li>
    ...
    <main class="container mx-auto px-4 py-6">
        <h1 class="text-2xl font-bold mb-6">Hasil Pertandingan</h1>
        ...
        <div class="space-y-6">
            ...
            <?php else: ?>
                <div class="bg-white rounded-lg shadow-md p-6 text-center">
                    <p class="text-gray-500">Tidak ada hasil pertandingan pada tanggal ini.</p>
                </div>
            <?php endif; ?>
        </div>
    </main>
